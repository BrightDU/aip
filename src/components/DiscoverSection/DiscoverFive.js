        ...
        return (
            <section className="section discover-area bg-gray overflow-hidden ptb_100">
                <div className="container">
                    <h2 className="pb-4 pb-sm-10 integrationHeader" style={{textAlign: strings.direction}}>{strings.einvoicingTitle}</h2>
                    <img className="diagram" src={`./img/newintegration.jpeg`} style={{width: '100%'}}/>
                    <hr/>
